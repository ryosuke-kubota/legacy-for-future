export default function SupportContent() {
  return (
    <section id="section03" className="py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative p-12 md:p-16 text-white text-center">
            <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              <span className="text-sm font-bold uppercase tracking-wider">SUPPORT SERVICES</span>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="group">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-2xl font-bold mb-2">新設・改修<br />プロジェクト推進</div>
                  <div className="text-md opacity-80">プロジェクト体制構築、全体工程管理など</div>
                </div>
              </div>
              ...
              <div className="group">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-2xl font-bold mb-2">カーボンニュートラル<br />設備導入</div>
                  <div className="text-md opacity-80">全体最適システムの構築、高効率設備の選定など</div>
                </div>
              </div>
              ...
              <div className="group">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-2xl font-bold mb-2">エンジニアリング<br />パートナー連携</div>
                  <div className="text-md opacity-80">協力企業の選定、必要な情報の提供・収集</div>
                </div>
              </div>
            </div>
          </div>
